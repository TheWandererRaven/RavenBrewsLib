...
public class BrewEffectsRegistry {
    public static final RegistryProvider<BrewEffectBehaviour> BREW_EFFECT_CORES = RegistryProvider.get(RavenBrewsLibRegistryKeys.BREW_EFFECT_CORES, Constants.MOD_ID, BrewEffectBehaviour.class);
